...
public class AssignementApplication implements CommandLineRunner {
	...
	public void run(String... strings) throws Exception {
		...
		ver.setMontantVirement(BigDecimal.TEN);
		ver.setCompteBeneficiaire(compte1);
		ver.setNom_prenom_emetteur("user1");
		ver.setDateExecution(new Date());
		ver.setMotifVersement("Versement Octo effectuee");

		versementRepository.save(ver);
